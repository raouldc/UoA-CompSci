...
/**
 * SAX tag handler. The Class contains a list of RssItems which is being filled
 * while the parser is working
 * 
 * @author ITCuties
 */
public class RssParseHandler extends DefaultHandler {
	...
	private boolean parsingLink, parsingDate, parsingDescription;
	...
	// start tag is being processed. When a title or link tag are being
