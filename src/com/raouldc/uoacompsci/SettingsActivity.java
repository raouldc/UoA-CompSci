        ...
        button.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                        ...
                        public boolean onPreferenceClick(Preference arg0) { 
                        	...
                        	if (!staffFile.exists()&& !coursesFile.exists()){
                        		Toast.makeText(getApplicationContext(), "Cache has already been cleared", Toast.LENGTH_LONG).show();
                        	}
                        	else{
                        		staffFile.delete();
                        		coursesFile.delete();
                        		Toast.makeText(getApplicationContext(), "Cache is now cleared", Toast.LENGTH_LONG).show();
                        	}
                            return true;
                        }
                    });
